//
// Created by Yu Zheng on 1/23/18.
//
...
void print_behavior(Behavior& behavior) {
  cout << "target lane   :" <<behavior.target_lane << endl;
  cout << "target speed  :" << behavior.target_speed << endl;
  cout << "target vehicle:";
  print_vector(behavior.target_vehicle);
}
